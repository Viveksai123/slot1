...
const Levelone = ({ username, rollnum, initialScore, timeLeft }) => {
  ...
  const handleCastSpell = () => {
    const dummyPassword = 'endpoint'; // Dummy password for testing
          ...
          <div className="popup-content">
            ...
            {isSpellValidated ? (
              <div>
                ...
                <p className=' animate__animated animate__fadeInRight'>Done with the game?, Fine Our HR will get back to you!!</p>
              ...
              <div className='column'>
                ...
                Have you ever heard Vigenère (key: HackTheBot): Lnfzhpru  
                </p>
